...
date: 2026-08-01
venue: 'Proceedings of the 2026 Conference on Machine Learning (COML 2026) (Oral Presentation, Top 1% of submissions)'
slidesurl: 'http://yourwebsite.com/files/slides-ipsum-lorem.pdf'
paperurl: 'https://openreview.net/forum?id=example123'
codeurl: 'https://github.com/dile45singchope/ipsum-lorem-all-you-need'
bibtexurl: 'http://yourwebsite.com/files/bibtex-ipsum-lorem.bib'
citation: 'John Smith, et al. (2026). "Ipsum Lorem is all you need." <i>Proceedings of the 2026 Conference on Machine Learning (COML 2026)</i> (Oral Presentation).'
---